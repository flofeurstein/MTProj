...
#define HAL_OTA_CHKDL_ADDR         0xFD34
#define HAL_OTA_INVRC_ADDR         0xFDC2
#define HAL_OTA_AVAIL_ADDR         0xFDFC
#define HAL_OTA_READ_ADDR          0xFE04
#define HAL_OTA_WRITE_ADDR         0xFE70
